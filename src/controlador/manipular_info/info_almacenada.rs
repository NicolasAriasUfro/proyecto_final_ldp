...
impl Entrada {
    ...
    pub fn cifrar_contra(&self,cifrador:Criptografia)->String{
...
pub fn descifrar_contra(contra_cifrada:String,nonce:String,cifrador:Criptografia)->String{
    ...
    let contra_descifrada_bytes=match cifrador.descifrar_bytes(nonce, &contra_cifrada_bytes){
        ...
        None=>panic!("algo salio mal con cifrar contra {:?} y nonce {:?} ",contra_cifrada_bytes,nonce)
    };
